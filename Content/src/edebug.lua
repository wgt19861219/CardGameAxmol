...
function EDDebug(msg)
  ...
  -- debug.debug() completely disabled for all platforms in localMode
  -- It blocks GUI apps by waiting for console input that never comes
  -- if EDFLAGWIN32 then
  --   if not (ed and ed.config and ed.config.localMode) then
  --     EDConsoleEnable(0)
  --     debug.debug()
  --     EDConsoleEnable(1)
  --   end
