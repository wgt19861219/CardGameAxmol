...
local function createWithText(info)
  ...
  alert:setDimensions(300, 125)
  pcall(function() alert:setHorizontalAlignment(kCCTextAlignmentLeft) end)
  pcall(function() alert:setVerticalAlignment(1) end)
...
local function createWithSprite(info)
  ...
  if info.spriteLabel then
    ...
    label:setDimensions(300, 125)
    pcall(function() label:setHorizontalAlignment(kCCTextAlignmentLeft) end)
    pcall(function() label:setVerticalAlignment(1) end)
...
local function createWithText(info)
  ...
  confirm:setDimensions(300, 125)
  pcall(function() confirm:setHorizontalAlignment(kCCTextAlignmentLeft) end)
  pcall(function() confirm:setVerticalAlignment(1) end)
